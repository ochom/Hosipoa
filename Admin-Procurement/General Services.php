...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
          ...
          <b><i class="oi oi-beaker"></i> General Services</b>
      	</div>
	...
	<div class="modal-dialog modal-dialog-lg" role="document">
		<div class="modal-content">
			<div class="modal-header bg-primary">
				<b class="glyphicon glyphicon-plus"></b><b class="modal-title" id="exampleModalLabel" style="color: #FFF;" > General Service</b>
			...
			<div class="modal-body">
				<div class="form-row">
					...
					<div class="form-group col-12 text-danger  col-md-4">
					...
					<div class="form-group col-sm-12 col-md-4">
						<button class="btn btn-outline-success col-12" onclick="SaveService()">
  ...
  <script>
	...
	function GetPages(){
		...
		$.ajax({
			...
			data:{GetPages:'1',page_size:page_size,item_type:'General Service'},
	...
	function GetItems(ps,pg){
		page_size = ps;
		page = pg;
		RichUrl($('#item_list'),{GetGeneralServices:'1',page:page,page_size:page_size});
	}
		...
		$.ajax({
			...
			success:function(response){
				...
				if (response.includes('success')) {
					SnackNotice(true,(selected_item_code === null)?'Service details saved successfully':'Service details updated successfully');
					$('#newItemPopUp').modal('toggle');
				}else{
