    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
      	...
      	<div class="text-secondary col-11" style=" background-color: white; box-shadow: 0 3px 5px rgba(0,0,0,0.5); padding: 10px 20px; margin:auto; border-radius: 3px;">      		
      		<b><i class="oi oi-cloud-download"></i> Import <?= $item_type?>'s List from File</b>
      	</div>
            ...
            <?php //import from file
              ...
              ?>
                    <tr>
                      ...
                      <td><?php echo  $string_array[5]?></td>
                      <td><?php echo  $string_array[6]?></td>
                      <td><?php echo  $string_array[7]?></td>
                      <td><?php echo  $string_array[8]?></td>
                    </tr>
            <?php } } fclose($File); } ?>
