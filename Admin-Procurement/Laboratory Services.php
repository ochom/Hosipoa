...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
          ...
          <b><i class="oi oi-beaker"></i> Laboratory Services</b>
      	</div>
	...
	<div class="modal-dialog modal-dialog-lg" role="document">
		<div class="modal-content" style="width: 800px; margin-left: calc((100% - 800px)/2);">
			<div class="modal-header bg-primary">
				<b class="glyphicon glyphicon-plus"></b><b class="modal-title" id="exampleModalLabel" style="color: #FFF;" > Laboratory Investigation</b>
			...
			<div class="modal-body">
				<div class="form-row">
					...
					<div class="form-group col-4">
						...
						<input type="text" class="form-control form-control-sm" id="item_des">
					</div>			
					<div class="form-group col-4">
						<label>Lower Result Range</label>
						<input type="text" class="form-control form-control-sm" id="low_range">
					</div>			
					<div class="form-group col-4">
						<label>Upper Result Range</label>
						<input type="text" class="form-control form-control-sm" id="up_range">
					</div>		
					<div class="form-group col-4">
						...
						<select class="form-control form-control-sm" id="item_category">
		                    ...
		                    <?php 
		                      $res = mysqli_query($conn,"SELECT * FROM tbl_item_drug_lab_types WHERE cat_for='Laboratory  Services' ORDER BY cat_name ASC");
					...
					<div class="category-group col-12">
						<button class="btn btn-outline-success" onclick="SaveLaboratoryService()">
  ...
  <script>
	...
	function GetPages(){
		...
		$.ajax({
			...
			data:{GetPages:'1',page_size:page_size,item_type:'Laboratory Service'},
	...
	function GetItems(ps,pg){
		page_size = ps;
		page = pg;
		RichUrl($('#item_list'),{GetLaboratoryServices:'1',page:page,page_size:page_size});
	}
	...
	function EditItem(item_code){
		...
		$.ajax({
			...
			success:function(response){
				...
				$("#low_range").val(item.purchase_price);		
				$("#up_range").val(item.selling_price);
	...
	function SaveLaboratoryService(){
		var item_name = $("#item_name").val();
		var item_type= 'Laboratory Service';
