...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="page_scroller">
        ...
        <a href="Body-Admission.php" class="btn btn-outline-primary">
            <i class="oi oi-person"></i><br>Body Admission
        </a>  
        <a href="Body List.php" class="btn btn-outline-primary">
            <i class="oi oi-book"></i><br>Logbook
        </a>
        <a href="../Orders/index.php?dep=Morgue" class="btn btn-outline-primary">
            <i class="oi oi-basket"></i><br> Orders
        </a>
      </div>
    </div>
  </div>
