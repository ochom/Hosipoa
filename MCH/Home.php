...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="page_scroller">
        ...
        <a href="New Client.php" class="btn btn-outline-primary">
            <i class="oi oi-person"></i><br> New Client
        </a>  
        <a href="Client List.php?type=ANC" class="btn btn-outline-primary">
            <i class="oi oi-document"></i><br>ANC Clinic
        </a>
        <a href="Client List.php?type=PNC" class="btn btn-outline-primary">
            <i class="oi oi-file"></i><br>PNC Clinic
        </a>
      </div>
    </div>
  </div>
