...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="page_scroller">
        ...
        <a href="Hospital.php" class="btn btn-outline-primary">
            <i class="oi oi-medical-cross"></i><br>Hospital
        </a> 
        <a href="Insurance Companies.php" class="btn btn-outline-primary">
            <i class="oi oi-briefcase"></i><br> Insurance Companies
        </a> 
        <a href="User Groups.php" class="btn btn-outline-primary">
            <i class="oi oi-lock-locked"></i><br>Groups & Privileges
        </a>
        <a href="System Users.php" class="btn btn-outline-primary">
            <i class="oi oi-people"></i><br> System Users
        </a>
      </div>
    </div>
  </div>
