...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="page_scroller">
        ...
        <a href="opd_queue.php" class="btn btn-outline-primary">
            <i class="oi oi-people"></i><br>Out-patient Queue
        </a>       
        <a href="ipd_queue.php" class="btn btn-outline-primary">
            <i class="oi oi-people"></i><br>In-patient Queue
        </a>
        <a href="Results opd_queue.php" class="btn btn-outline-primary">
