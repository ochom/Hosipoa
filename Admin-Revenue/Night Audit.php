...
<head>
  ...
  <style type="text/css">
    .receiptPop{
      width: 100%; height: 100%; position: fixed; top: 0; left: 0; background-color: rgba(200,200,200,0.5); display: none;
    }
    #receipt_view{
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="text-secondary col-11" style=" background-color: white; box-shadow: 0 3px 5px rgba(0,0,0,0.5); padding: 10px 20px; margin:auto; border-radius: 3px;">
          <b><i class="oi oi-people"></i> In-patient Night Audit</b>
        </div> 
          <div class="page_scroller">
            <table class="table table-sm table-bordered table-striped">
              ...
              <tbody id="clients_list" style="cursor: pointer;">
                <!-- ADD FROM CRUD -->
              </tbody>
            </table>
          </div>
      ...
      <div class="modal-body">
        <div class="form-row">
          ...
          <div class="form-group col-4">
            ...
            <input class="form-control form-control-sm" id="amount_paid" onkeyup="$('#balance').val($(this).val() - $('#total_bill').val())">
          </div>
          <div class="form-group col-4">
...
<div class="receiptPop">
  <div id="receipt_view">
    ...
    <button class="print_me" onclick="$('.receiptPop').toggleClass('show_receipt')"><i class="oi oi-x"></i></button>
    <div id="receipt">
      <!-- js -->
    </div>
  </div>
...
<!-- Menu Toggle Script -->
  ...
  function GetCost(item_name){
    $.ajax({
      method:'post',
      url:'crud.php',
      data:{GetCost:'1',item_name:item_name},
      success:function(response){
        $('#cost').val((+response).toFixed(2));
      }
    });
   }
        ...
        $.ajax({
          ...
          success:function(response){
            ...
            if (response.includes('success')) {
              ...
              $('.receiptPop').toggleClass('show_receipt');
