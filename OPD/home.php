...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
        ...
        <a class="navbar-brand" href="" style="color: rgb(255,153,0);"> Out-Patient</a>
    </div>
      </nav>
      ...
      <div class="page_scroller">
        ...
        <a href="Triage Queue.php" class="btn btn-outline-primary">
            <i class="oi oi-timer"></i><br>Triage
        </a>
        <a href="Clinician Queue.php" class="btn btn-outline-primary">
            <i class="oi oi-chat"></i><br>Clinician
        </a>
      </div>
    </div>
  </div>
